...
import com.dhobi.perfectdhobidelivery.databinding.ActivityLoginBinding
    ...
    private fun Loginapi(mobile:String){
        ...
        if (Utilities.isNetworkAvailable(this)) {
            ...
            viewModel.login(devicetype = "android", key = "d77d7bd089b6ea50c35aff32c2ff4608",
                source = "mob", LoginRequestModel(phone = mobile, deviceToken = "wqwqeqeqeq", userType = "delivery")
            ).observe(this) {
                it?.let { resource ->
